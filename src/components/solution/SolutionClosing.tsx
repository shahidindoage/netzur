...
export const SolutionCtaBanner: React.FC<Props> = ({ data, onOpenDemo }) => {
  return (
...
export const SolutionRelated: React.FC<Props> = ({ data }) => {
    ...
    <section className="bg-white py-10 sm:py-18 border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          ...
          <p className="text-sm text-slate-500 max-w-xs">Keep exploring the platform - every solution runs on the same billing core.</p>
        </div>
...
export const SolutionFaq: React.FC<Props> = ({ data }) => {
  ...
  return (
    <section className="bg-white py-10 sm:py-18">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-slate-500 text-sm mb-10">Everything operators ask before switching on this solution.</p>
...
export const SolutionFooterCta: React.FC<Props> = ({ data, onOpenDemo }) => {
  return (
